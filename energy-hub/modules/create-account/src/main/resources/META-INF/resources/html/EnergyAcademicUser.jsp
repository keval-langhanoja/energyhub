                   ...
                   <div class="card info">
				    ...
				    <c:when test="${edit}">
				    	...
				    	<button class="blueBorderBtn mt-3 mx-3" id="innovationProg"
				    		onclick="location.href = '/academic';"><liferay-ui:message key="AddInnovationProgram" /></button>
				    </c:when>
					<c:when test="${!edit}">
						<span class=""><liferay-ui:message key="YouAreRegistering" /> <span class="bold"><liferay-ui:message key="AcademicUser" /></span></span>
...
<!--                           </div> -->
                      ...
                      <div class="separator"></div>
                           <h1><liferay-ui:message key="InstitutionInformation" /></h1>
                       <div class="row">
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer">
                            <label><liferay-ui:message key="InstitutionName" /></label>
						     <aui:input cssClass="" label="" id="universityName" name="universityName"></aui:input>
                           </div>
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer">
                            <label><liferay-ui:message key="Acronym" /></label>
						     <aui:input cssClass="" label="" id="Acronym" name="Acronym"></aui:input>
                           </div>
                           <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer">
                            <label><liferay-ui:message key="InstitutionWebsite" /></label>
						     <aui:input label="" id="LinkToWebsite" name="LinkToWebsite"></aui:input>
                           </div>
                           <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer" style="position: relative">
	                            <label><liferay-ui:message key="MobileNumber" /></label>
                           ...
                           <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer">
	                    		<label><liferay-ui:message key="InstitutionLogo" /></label>
			                    <div class="add-innovation-dropdown uploadButton-div"> 
			                         <aui:input style="opacity:0;position: absolute;display:none;" type="file" id="coverImage" name="coverImage" label="" 
                           ...
                           <div class="col-12 col-md-12 mt-4 description inputContainer required">
                            <label><liferay-ui:message key="InstitutionDescription" /></label>
                      ...
                      <div class="d-flex justify-content-end fixBtns my-5">
						<button class="blueBorderBtn reset mt-3 mx-3" type="" id="clearCreateAccount"><liferay-ui:message key="Clear" /></button>
				   		<aui:button cssClass="blueBtn submit mt-3" onclick="ajaxCall('key')" type="submit" id="save" value="Send"></aui:button>
                      </div>
...
// 		document.getElementById("<portlet:namespace />SubscribeToNewsletters").value = "${userData.SubscribeToNewsletters}";
		...
		document.getElementById("<portlet:namespace />Acronym").value = "${userData.Acronym}";
		document.getElementById("<portlet:namespace />universityName").value = "${userData.universityName}";
...
//  			 <portlet:namespace />SubscribeToNewsletters: $("#<portlet:namespace/>SubscribeToNewsletters").val(),
 			 <portlet:namespace />universityName: $("#<portlet:namespace/>universityName").val(),
 			 <portlet:namespace />Acronym: $("#<portlet:namespace/>Acronym").val(),
