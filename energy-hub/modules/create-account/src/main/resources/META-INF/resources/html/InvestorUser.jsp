               ...
               <div class="userTypeCard position-relative topBorder mt-3 py-5 px-5">
                   <div class="card info">
				    ...
				    <c:when test="${edit}">
				    	...
				    	<button class="blueBorderBtn mt-3 mx-3" id="innovationChallenge"
				    		onclick="location.href = '/innovation?p_r_p_categoryId=${categId}';"><liferay-ui:message key="AddInnovationChallenge" /></button>
				    </c:when>
					<c:when test="${!edit}">
						<span class=""><liferay-ui:message key="YouAreRegistering" /> <span class="bold"><liferay-ui:message key="InvestorUser" /></span></span>
					   ...
					   <h1><liferay-ui:message key="AboutTheProject" /></h1>
						...
						<label><liferay-ui:message key="Website" /></label>
					     <aui:input cssClass="" label="" id="CompanyWebsite" name="CompanyWebsite"></aui:input>
                          ...
                          <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer customCoverImage" style="position: relative">
	                            <label><liferay-ui:message key="MobileNumber" /></label>
                           ...
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer customCoverImage">
	                    ...
	                    <div class="add-innovation-dropdown uploadButton-div"> 
                           ...
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer customFiles">
			                    ...
			                    <div class="add-innovation-dropdown uploadButton-div"> 
			                         ...
			                         <button type="button" id="files-custom-button" class="uploadButton"/>
			                          <img id="tmpImg" src="/o/energy-hub-theme/images/upload.svg"> <liferay-ui:message key="UploadFile" />
			                      	</button>
                           ...
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer">
							<label><liferay-ui:message key="YearOfEstablishment" /></label>
                                ...
                                <div class="col-12 col-md-4 col-xl-4 mt-4 inputContainer required">
									<label><liferay-ui:message key="TypeOfSupportInvestor" /></label>
                                    <aui:select
		                            cssClass="browser-default custom-select custom-select-lg mb-4 signup_select"
		                            label="" id="TypeOfSupportInvestor" name="TypeOfSupportInvestor"> 
		                            <aui:option disabled="true" selected="true" value=""><liferay-ui:message key="SelectOption" /></aui:option>
			                            <c:forEach var="elt" items="${TypeOfSupportInvestor}">
											<aui:option value="${elt.Id}">
												<c:choose>
													<c:when test="${lang == 'en_US'}">
														${elt.Text}
                                ...
                                <div class="col-12 col-md-4 col-xl-4 mt-4 inputContainer required">
									<label><liferay-ui:message key="Stage" /></label>
	                                  <aui:select
		                            cssClass="browser-default custom-select custom-select-lg mb-4 signup_select"
		                            label="" id="Stage" name="Stage"> 
		                            <aui:option disabled="true" selected="true" value=""><liferay-ui:message key="SelectOption" /></aui:option>
				            	<c:forEach var="elt" items="${Stage}">
							<aui:option value="${elt.Id}">
								<c:choose>
									<c:when test="${lang == 'en_US'}">
										${elt.Text}
                                ...
                                <div class="col-12 col-md-4 mt-4 inputContainer required">
                                ...
                                <div class="col-12 col-md-12 mt-4 description inputContainer required">
									<label><liferay-ui:message key="PleaseEnterDescription" /></label>
                           		<aui:input cssClass="" id="description" type="textarea"  name="description" label=""></aui:input>
                           </div>
                            </div>
                        </div>
...
// 		document.getElementById("<portlet:namespace />SubscribeToNewsletters").value = "${userData.SubscribeToNewsletters}";
		...
		$("#<portlet:namespace />TypeOfSupportInvestor").val("${userData.TypeOfSupportInvestor}").change(); 
		$("#<portlet:namespace />Stage").val("${userData.Stage}").change();  
		document.getElementById("<portlet:namespace />description").value = "${userData.description}";
...
//  			 <portlet:namespace />SubscribeToNewsletters: $("#<portlet:namespace/>SubscribeToNewsletters").val(),
 			 ...
 			 <portlet:namespace />TypeOfSupportInvestor: $("#<portlet:namespace/>TypeOfSupportInvestor").val(),
 			 <portlet:namespace />Stage: $("#<portlet:namespace/>Stage").val(),
 			 <portlet:namespace />Expectations: $("#<portlet:namespace/>Expectations").val(),
 			 <portlet:namespace />description: $("#<portlet:namespace/>description").val(),
 		};
