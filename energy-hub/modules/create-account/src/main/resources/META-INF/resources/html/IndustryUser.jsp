                   ...
                   <div class="card info">
                       <div class="d-flex">
                           ...
                           <div class="choosenUserDetails py-2 px-4">
							<span class=""><liferay-ui:message key="YouAreRegistering" /> <span class="bold"><liferay-ui:message key="IndustryUser" /></span></span>
...
<!--                            </div> -->
                       ...
                       <div class="separator"></div>
                           <h1> <liferay-ui:message key="IndustryInformation" /></h1>
                        <div class="row">
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer">
                           ...
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer">
                            ...
                            <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer required">
                                ...
                                <aui:select
		                            cssClass="browser-default custom-select custom-select-lg mb-4 signup_select"
		                            label="" id="Sector" name="Sector">
		                            <aui:option disabled="true" selected="true" value=""><liferay-ui:message key="SelectOption" /></aui:option>
		                            <c:forEach var="elt" items="${Sector}">
										<aui:option value="${elt.Id}">
											<c:choose>
												<c:when test="${lang == 'en_US'}">
													${elt.Text}
                            ...
                            <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer">
								<label><liferay-ui:message key="ALIRegistrationNumber" />#</label>
                          	 	<aui:select
		                            cssClass="browser-default custom-select custom-select-lg mb-4 signup_select" multiple="true"
		                            label=" " id="ALIRegistrationNumber" name="ALIRegistrationNumber"> 
			                            <c:forEach var="elt" items="${ALIRegistrationNumber}">
											<aui:option value="${elt.Id}">
												<c:choose>
													<c:when test="${lang == 'en_US'}">
														${elt.Text}
                            ...
                            <div class="col-12 col-md-6 col-xl-4 mt-4 inputContainer required">
								<label><liferay-ui:message key="Expectations" /></label>
                                <aui:select
		                            cssClass="browser-default custom-select custom-select-lg mb-4 signup_select"
...
// 		document.getElementById("<portlet:namespace />SubscribeToNewsletters").value = "${userData.SubscribeToNewsletters}";
		...
		var act = "${userData.ALIRegistrationNumber}";
		$.each(act.replaceAll('/', ',').split(","), function(i,e){
			$("#<portlet:namespace />ALIRegistrationNumber option[value='" + e + "']").prop("selected", true);
		});
		...
		$("#<portlet:namespace />Sector").val("${userData.Sector}").change(); 
...
//  			 <portlet:namespace />SubscribeToNewsletters: $("#<portlet:namespace/>SubscribeToNewsletters").val(),
 			 ...
 			 <portlet:namespace />Sector: $("#<portlet:namespace/>Sector").val(),
 			 <portlet:namespace />ALIRegistrationNumber: $("#<portlet:namespace/>ALIRegistrationNumber").val(),
