                   ...
                   <div class="card info">
                       <div class="d-flex">
                           ...
                           <div class="choosenUserDetails py-2 px-4">
							<span class=""><liferay-ui:message key="YouAreRegistering" /> <span class="bold"><liferay-ui:message key="PolicyUser" /></span></span>
...
<!--                           </div> -->
                      ...
                      <div class="separator"></div>
                           <h1><liferay-ui:message key="PolicyMakerInformation" /></h1>
                       <div class="row">
                           <div class="col-12 col-md-6 col-xl-4 mt-4 required inputContainer">
                           ...
                           <div class="col-12 col-md-4 mt-4 inputContainer required">
							<label><liferay-ui:message key="OrganizationType" /></label>
                           		<aui:select
		                            ...
		                            label="" id="OrganizationType" name="OrganizationType"> 
			                            <c:forEach var="elt" items="${OrganizationType}">
											<aui:option value="${elt.Id}">
												<c:choose>
													<c:when test="${lang == 'en_US'}">
														${elt.Text}
...
// 		document.getElementById("<portlet:namespace />SubscribeToNewsletters").value = "${userData.SubscribeToNewsletters}";
		...
		var type = "${userData.OrganizationType}";
		$.each(type.replaceAll('/', ',').split(","), function(i,e){
			$("#<portlet:namespace />OrganizationType option[value='" + e + "']").prop("selected", true);
		});
	}
...
//  			 <portlet:namespace />SubscribeToNewsletters: $("#<portlet:namespace/>SubscribeToNewsletters").val(),
 			 ...
 			 <portlet:namespace />OrganizationType: $("#<portlet:namespace/>OrganizationType").val(),
