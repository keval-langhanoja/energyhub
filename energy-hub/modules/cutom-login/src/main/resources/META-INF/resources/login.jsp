...
<c:choose>
	...
	<c:otherwise>
		...
		<div class="login-container-body d-flex justify-content-center align-items-center">
			<div class="login-container">
				<div class=" ">
	                <div class="row">
	                    <div class="d-flex justify-content-center align-items-center col-lg-12 pb-5">
	                        <h4 style="color:#00AE8D;"><liferay-ui:message key="LoginMain" /></h4>
	                    </div>
	                </div>
	            </div>
