<#include init />
    ...
    <link rel="stylesheet" href="/o/energy-hub-theme/style/communityModule.css">
...
<!--                        <a><@liferay.language key="Signup" /></a> -->
                ...
                <div class="MainTitleHeaderDiv">
                    ...
                    <p class="mt-1 mainDetails"><@liferay.language key="CommunitySubHeader" /></p>
                </div>
            </div>
            <div class="userTypeCard position-relative topBorder mt-5 py-5 px-5">
                    <div class="d-flex justify-content-between align-items-center topTools">
                       <div class="dropdown programsDropdown" style="display: none;" data-toggle="dropdown" aria-expanded="false">
                            <div class=""><span><@liferay.language key='Programs' /></span><img class="mx-3"
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="#" class="active"><img src="/o/energy-hub-theme/images/programList/community.svg"><@liferay.language key='Community' /></a>
                            ...
                            <#if !is_signed_in> 
                            	<div class="card info">
                                    <div class="d-flex justify-content-start align-items-center py-2 px-3">
                                    	...
                                    	<div class="px-3 text">
                                            <p class="mb-0 bold"><@liferay.language key='CommunityHint' />  
