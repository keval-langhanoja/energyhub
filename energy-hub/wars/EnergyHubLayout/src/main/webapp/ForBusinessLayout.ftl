...
<!--                        <a><@liferay.language key="Signup" /></a> -->
                ...
                <div class="MainTitleHeaderDiv">
	            	...
	            	<#if currentCategName == "Resources" || the_title == "Resources">
	            		<#if currentUrl?contains("publications")>
	            			<p class="mt-1 mainDetails" id="MainTitleSubHeader">
                    			<@liferay.language key="PublicationSeeAllSubHeader" />
                    		</p>
                    	<#else>
	            			<p class="mt-1 mainDetails" id="MainTitleSubHeader">
                    			<@liferay.language key="ResourcesSubHeader" />
                    		</p>
	            		</#if>
		           	</#if>
            ...
            <div class="userTypeCard position-relative topBorder mt-5 py-5 px-5">
                    <div class="d-flex justify-content-between align-items-center topTools">
                        <div class="dropdown programsDropdown" style="display: none;" data-toggle="dropdown" aria-expanded="false">
                            ...
                            <a href="#" class="active"><img src="/o/energy-hub-theme/images/programList/bussines.svg"><@liferay.language key='ForBusiness' /></a>
                            <a href="#"><img src="/o/energy-hub-theme/images/programList/community.svg"><@liferay.language key='Community' /></a>
                            <a href="#"><img src="/o/energy-hub-theme/images/programList/industry.svg"><@liferay.language key='Industry' /></a>
                    ...
                    <div class="mt-4">
                        <div class="mainGrid grid">
                            ...
                            <div class=" pb-5">
								<#if !is_signed_in && (currentCategName == "Resources" || the_title == "Resources")>
									<#if currentUrl?contains("publications")>
										<div class="card info">
											<div class="d-flex justify-content-start align-items-center py-2 px-3">
												...
												<div class="px-3 text">
													<p class="mb-0 bold"><@liferay.language key='publicationsHint' />  
									...
									<#else>
										<div class="card info">
											<div class="d-flex justify-content-start align-items-center py-2 px-3">
												<div><img width="30px" src="/o/energy-hub-theme/images/userType/about.svg"></div>
												<div class="px-3 text">
													<p class="mb-0 bold"><@liferay.language key='forBusinessHint' />  
														<a href="${sign_in_url}" class="links"><@liferay.language key='SignIn' /></a>
													</p>
													<p class="mb-0"><@liferay.language key='DontHaveAccount' />? 
														<a href="/userType" class="links"><@liferay.language key='Signup' /></a>
