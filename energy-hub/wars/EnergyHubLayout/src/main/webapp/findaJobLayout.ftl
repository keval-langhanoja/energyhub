                           	...
                           	<!-- <div class="card info">
                                    <div class="d-flex justify-content-start align-items-center py-2 px-3">
                                        <div><img width="30px" src="/o/energy-hub-theme/images/userType/about.svg"></div>
                                         <div class="px-3 text">
                                            <p class="mb-0 bold"><@liferay.language key='EntrepreneurUserMessage' /><a
                                                  href="${sign_in_url}" class="links"><@liferay.language key='SignIn' /></a></p>
                                            <p class="mb-0">Don't have account ? <a href="/userType" class="links"><@liferay.language key='CreateAccount' /></a></p>
                                    	</div>
                                    </div>
                                </div>-->
                            </#if>
